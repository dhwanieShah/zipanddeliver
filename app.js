...
// const { zipAndDeliverDatabase, imerferenceDatabase } = mongodb.getConnections();
// if (!zipAndDeliverDatabase || !imerferenceDatabase) {
//   throw new Error("Database connections are not properly initialized.");
// }
